      ...
      <PageHeader title="Conexión de" highlight="TikTok" description="Conecta tu cuenta de TikTok Business para automatización de mensajes directos." icon={FaTiktok}
        action={existingConnection ? (
          ...
          <div className="px-4 h-10 rounded-xl flex items-center gap-2 bg-amber-500/10 text-amber-500 text-[10px] font-black uppercase tracking-widest">
            <div className="w-2 h-2 rounded-full bg-amber-500" /> Sin Conexión
          </div>
        )}
      />
      <div className="flex-1 bg-white dark:bg-[#11141b]/50 backdrop-blur-md rounded-2xl border border-gray-100 dark:border-gray-800/50 shadow-lg flex flex-col min-h-0">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            {existingConnection ? (
              ...
              <div className="space-y-6">
                ...
                <div className="p-6 bg-gray-500/5 rounded-3xl border border-gray-500/10 space-y-3">
