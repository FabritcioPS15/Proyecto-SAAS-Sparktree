  ...
  return (
    <div className="h-full animate-in fade-in duration-500 flex flex-col gap-1">
      <PageHeader
        title="Conexión de"
        highlight="TikTok"
        description="Conecta tu cuenta de TikTok para automatización de mensajes directos."
        icon={FaTiktok}
        action={
          existingConnection ? (
          ...
          <div className="max-w-2xl mx-auto">
            {existingConnection ? (
              <div className="space-y-6">
                ...
                <div className="p-6 bg-gray-500/5 rounded-3xl border border-gray-500/10">
                  <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-3">ℹ️ Información</h4>
                  <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                    Tu cuenta de TikTok está conectada. Los flujos de automatización creados en el Constructor de Bots funcionarán automáticamente con esta conexión.
                  </p>
                </div>
              </div>
            ) : (
              <div className="space-y-6">
                <div className="p-6 bg-slate-50/50 dark:bg-white/2 rounded-3xl border border-slate-100 dark:border-white/5">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="p-2 bg-gradient-to-br from-black to-gray-800 rounded-lg text-white shadow-lg shadow-gray-500/20">
                  ...
                  <form onSubmit={handleConnect} className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-white text-sm font-medium focus:outline-none focus:ring-2 focus:ring-gray-500/20 focus:border-gray-500 transition-all"
                        required
                      />
                    </div>
                    ...
                    <button
                      type="submit"
                      disabled={loading || isConnecting('tiktok')}
                      className="w-full h-12 bg-gradient-to-r from-black to-gray-800 hover:from-gray-800 hover:to-gray-900 text-white rounded-xl font-bold text-[10px] uppercase tracking-widest transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {loading || isConnecting('tiktok') ? 'Conectando...' : 'Conectar con TikTok'}
                    </button>
                  </form>
                </div>
