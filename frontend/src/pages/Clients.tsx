      ...
      <PageHeader
        ...
        action={
          <div className="flex items-center gap-3">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 px-4 h-10 flex items-center gap-3 rounded-lg border border-gray-200 dark:border-gray-700">
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex-1 relative group">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all text-gray-900 dark:text-white text-sm"
              />
            </div>
            <div className="flex flex-wrap items-center gap-3">
              <select
                ...
                className="px-4 py-2.5 bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all text-gray-900 dark:text-white text-sm cursor-pointer min-w-[160px]"
              >
              ...
              <div className="flex items-center bg-gray-50 dark:bg-gray-800/50 rounded-lg p-1 border border-gray-200 dark:border-gray-700/50">
                <button
                  onClick={() => setViewMode('table')}
                  className={`p-1.5 rounded-md transition-all ${viewMode === 'table' ? 'bg-white dark:bg-gray-700 shadow-sm text-emerald-600 dark:text-emerald-400' : 'text-gray-400 hover:text-gray-600 dark:hover:text-gray-300'}`}
                          ...
                          <div className="flex gap-1">
                            {user.channels && Object.keys(user.channels).length > 0 ? (
                              Object.keys(user.channels).map((channel) => (
                                <span key={channel} className="px-2 py-1 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 rounded text-[9px] font-bold uppercase">
                                  {channel}
                                </span>
                              ))
                            ) : (
