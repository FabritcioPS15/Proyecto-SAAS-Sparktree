...
export const ProfileSelection = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0c10] flex flex-col items-center justify-center p-6 antialiased">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-accent-500/10 via-[#0a0c10] to-[#0a0c10] pointer-events-none" />
          ...
          {MOCK_PROFILES.map((profile) => (
            ...
            >
              ...
              `}>
                ...
                {selected === profile.id && (
                  <div className="absolute -top-3 -right-3 w-8 h-8 bg-white text-black rounded-full flex items-center justify-center shadow-lg border-2 border-[#0a0c10]">
