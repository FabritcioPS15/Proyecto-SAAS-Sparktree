...
export const StaffManagement = () => {
  ...
  const getRoleDescription = (role: string) => {
    const descriptions: { [key: string]: string } = {
      'super_admin': 'Acceso total al sistema, gestiÃ³n de todas las organizaciones y configuraciÃ³n global',
      'admin': 'GestiÃ³n completa de usuarios, configuraciÃ³n de organizaciÃ³n y acceso a todas las herramientas',
      'empresa': 'Acceso a datos de empresa, gestiÃ³n de clientes y reportes de negocio',
      'staff': 'Soporte tÃ©cnico, gestiÃ³n de flujos y atenciÃ³n a usuarios finales',
      'agent': 'AtenciÃ³n bÃ¡sica a clientes, acceso limitado a herramientas de comunicaciÃ³n'
    };
  ...
  return (
    <PageContainer>
      ...
      <PageBody>
        {viewMode === 'table' ? (
          <div className="bg-white/50 dark:bg-dark-card/50 backdrop-blur-xl rounded-[2.5rem] border border-gray-100 dark:border-gray-800/50 shadow-sm overflow-hidden">
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-gray-100 dark:border-gray-800/50">
                    ...
                    <th className="px-6 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest">OrganizaciÃ³n</th>
                        ...
                        <td className="px-6 py-5">
                          <div className="flex flex-col gap-1">
                            ...
                            <span className="text-[8px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">
                              {getUserUsageTime(user).days} dÃ­as
                            </span>
                          </div>
                        </td>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {loading ? (
              ...
              users.map((user) => (
                <div key={user.id} className="group bg-white dark:bg-dark-card p-6 rounded-[2.5rem] border border-gray-100 dark:border-gray-800/50 shadow-sm hover:shadow-2xl transition-all duration-500 relative overflow-hidden flex flex-col">
          ...
          <div className="bg-white dark:bg-[#0f1115] w-full max-w-md rounded-[2rem] border border-slate-200 dark:border-white/5 shadow-2xl overflow-hidden relative">
            ...
            <div className="p-8 relative z-10">
              ...
              <form onSubmit={editingUser ? handleUpdateUser : handleCreateUser} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-4 py-3.5 dark:bg-white/5 border border-slate-200 dark:border-slate-800 rounded-2xl focus:border-accent-500/50 focus:ring-4 focus:ring-accent-500/5 outline-none transition-all font-bold text-sm text-slate-900 dark:text-white placeholder-slate-400/60 ${editingUser ? 'opacity-50 cursor-not-allowed' : ''}`}
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3.5 dark:bg-white/5 border border-slate-200 dark:border-slate-800 rounded-2xl outline-none font-bold text-sm text-slate-900 dark:text-white appearance-none cursor-pointer focus:border-accent-500/50 focus:ring-4 focus:ring-accent-500/5 transition-all"
                    >
                  ...
                  <div className="space-y-2">
                    <label className="block text-[9px] font-black text-slate-400 uppercase tracking-widest px-1">OrganizaciÃ³n</label>
                    <select
                ...
                {!editingUser && (
                  <div className="space-y-2">
                    <label className="block text-[9px] font-black text-slate-400 uppercase tracking-widest px-1">ContraseÃ±a Temporal</label>
                    <div className="relative">
                      <input
                        type="password"
                        required
            ...
            <div className="p-6 relative z-10">
              ...
              <div className="space-y-3 mb-6">
                {[
                  ...
                  { role: 'admin', title: 'Administrador', desc: 'GestiÃ³n completa de organizaciÃ³n', perms: ['Usuarios', 'Config', 'Reportes'] },
                  { role: 'empresa', title: 'Empresa', desc: 'Acceso a datos de negocio', perms: ['Clientes', 'Reportes', 'CampaÃ±as'] },
                  { role: 'staff', title: 'Staff', desc: 'Soporte tÃ©cnico y flujos', perms: ['Soporte', 'Flujos', 'Usuarios'] },
                  { role: 'agent', title: 'Agente', desc: 'AtenciÃ³n bÃ¡sica a clientes', perms: ['Chat', 'AtenciÃ³n', 'BÃ¡sico'] }
                ].map((roleInfo) => (
