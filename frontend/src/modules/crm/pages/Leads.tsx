    ...
    const fetchLeads = async () => {
      try {
        ...
        const mappedLeads = rawLeads.map((contact: any) => ({
          ...
          phone: contact.phone_number || contact.phone || 'Sin nÃºmero',
  ...
  return (
    <PageContainer>
      <PageHeader 
        title="GestiÃ³n de"
        highlight="Leads"
        description="Monitoriza a los usuarios que han completado el Happy Path y estÃ¡n listos para la conversiÃ³n."
        icon={TrendingUp}
        action={
          <button
      ...
      <PageBody>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 mb-2">
          {[
            ...
            <div key={i} className="bg-white dark:bg-dark-card rounded-[1.5rem] p-4 shadow-lg shadow-slate-200/50 dark:shadow-none border border-gray-100 dark:border-gray-800/50 group hover:scale-105 transition-all duration-500">
        ...
        {/* Filters Area */}
        <div className="bg-white dark:bg-gray-900 rounded-xl p-4 border border-gray-200 dark:border-gray-800 shadow-sm mb-4">
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex-1 relative group">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all text-gray-900 dark:text-white text-sm"
              />
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              <select
                ...
                className="px-4 py-2.5 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all text-gray-900 dark:text-white text-sm cursor-pointer min-w-[160px]"
              >
        ...
        <div className="bg-white dark:bg-dark-card rounded-[1.5rem] shadow-lg shadow-slate-200/50 dark:shadow-none border border-gray-100 dark:border-gray-800/50 overflow-hidden flex-1 min-h-0">
                    ...
                    <td className="px-4 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          ...
                          className="p-2 dark:bg-slate-800/50 hover:bg-slate-900 hover:text-white dark:hover:bg-white dark:hover:text-slate-900 rounded-xl transition-all duration-300 shadow-sm border border-slate-100 dark:border-slate-700/50"
                        >
        ...
        {selectedLead && (
          <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md flex items-center justify-center p-6 z-50 animate-in fade-in duration-300">
            <div className="bg-white dark:bg-dark-card rounded-[3rem] shadow-2xl border border-gray-200 dark:border-gray-800/50 max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col animate-in zoom-in-95 duration-500">
              ...
              <div className="p-10 pb-6 flex items-start justify-between relative overflow-hidden">
                ...
                <button
                  ...
                  className="w-12 h-12 flex items-center justify-center dark:bg-slate-800 rounded-full hover:bg-slate-900 hover:text-white dark:hover:bg-white dark:hover:text-slate-900 transition-all text-2xl font-light shadow-sm"
                >
                  âœ•
                </button>
              </div>
              ...
              <div className="p-10/50 dark:bg-slate-800/20 border-t border-slate-100 dark:border-slate-800/50 flex gap-4">
