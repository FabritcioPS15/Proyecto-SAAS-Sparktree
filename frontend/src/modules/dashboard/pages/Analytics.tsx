          ...
          <div className="flex items-center gap-2">
            <div className="relative">
              <select
                ...
                className="appearance-none bg-white dark:bg-dark-card border border-slate-200 dark:border-slate-700 rounded-lg px-4 py-2 pr-10 text-sm font-bold text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-accent-500/20 cursor-pointer"
              >
      ...
      <PageBody scrollable={true}>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-2">
          {[
            ...
            <div key={idx} className="bg-white dark:bg-dark-card rounded-xl p-5 border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-all duration-300 group overflow-hidden relative">

              <div className="flex items-center justify-between mb-4 relative z-10">
                <div className="p-2.5 dark:bg-dark-card rounded-lg text-gray-600 dark:text-gray-400 group-hover:bg-emerald-50 dark:group-hover:bg-emerald-900/20 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors border border-gray-200 dark:border-gray-700">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          <div className="bg-white dark:bg-dark-card rounded-xl p-6 border border-gray-200 dark:border-gray-800 shadow-sm flex flex-col min-h-[400px]">
          ...
          <div className="lg:col-span-2 bg-white dark:bg-dark-card rounded-xl p-8 border border-gray-200 dark:border-gray-800 shadow-sm flex flex-col min-h-[450px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 flex-1 min-h-0">
          <div className="bg-white dark:bg-dark-card rounded-xl p-6 border border-gray-200 dark:border-gray-800 shadow-sm flex flex-col">
