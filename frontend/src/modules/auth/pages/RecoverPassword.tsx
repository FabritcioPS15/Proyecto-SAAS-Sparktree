...
export const RecoverPassword = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || err.message || 'Error al procesar la solicitud. Por favor intenta de nuevo.');
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div className="relative z-10 w-full max-w-md space-y-16">
          <div className="flex flex-col items-center text-center space-y-6">
            ...
            <div className="space-y-6">
              <h2 className="text-5xl font-bold text-white leading-tight tracking-tight">
                Recupera tu <br/>
                <span className="inline-block pb-1 pr-6 text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-accent-400 italic">acceso</span>
              </h2>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-5 bg-white/[0.02] border border-white/5 rounded-2xl backdrop-blur-sm group hover:bg-white/[0.04] transition-all duration-500">
              ...
              <p className="text-xs text-gray-500 mt-2 leading-relaxed">Enlace de recuperación válido por 1 hora.</p>
            </div>
            <div className="p-5 bg-white/[0.02] border border-white/5 rounded-2xl backdrop-blur-sm group hover:bg-white/[0.04] transition-all duration-500">
              ...
              <p className="text-sm font-bold text-white">Rápido</p>
              <p className="text-xs text-gray-500 mt-2 leading-relaxed">Recupera tu acceso en minutos.</p>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 relative overflow-y-auto">
        ...
        <div className="w-full max-w-md relative z-10 py-12">
          ...
          {!success ? (
            ...
            <div className="space-y-6">
              ...
              <button 
                ...
                className="w-full py-4 bg-white/[0.03] hover:bg-white/[0.05] border border-white/5 text-white rounded-xl font-bold text-sm transition-all active:scale-[0.98] flex items-center justify-center gap-2 group"
              >
          ...
          <div className="mt-8 text-center">
            <Link to="/login" className="inline-flex items-center gap-2 text-gray-500 hover:text-white text-sm font-medium transition-colors">
