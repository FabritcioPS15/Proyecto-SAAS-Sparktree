    ...
    <PageContainer>
      ...
      <PageBody scrollable={true}>
        ...
        {viewMode === 'grid' ? (
          ...
          <div className="bg-white dark:bg-dark-card rounded-2xl border border-gray-100 dark:border-gray-800/50 overflow-hidden">
        ...
        {showCreateForm && (
          <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md flex items-center justify-center p-6 z-[110]">
            <div className="bg-white dark:bg-dark-card rounded-3xl shadow-xl max-w-xl w-full p-10 font-inter">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input type="text" value={newFlowData.name} onChange={e => setNewFlowData({ ...newFlowData, name: e.target.value })} className="w-full px-5 py-4 dark:bg-slate-800 border-none rounded-2xl outline-none font-bold text-slate-900 dark:text-white" placeholder="Ej: Soporte VIP" />
                </div>
                <div>
                  <label className="block text-[10px] font-black uppercase tracking-widest mb-2 text-slate-400">Categoría</label>
                  <select value={newFlowData.category} onChange={e => setNewFlowData({ ...newFlowData, category: e.target.value as any })} className="w-full px-5 py-4 dark:bg-slate-800 border-none rounded-2xl outline-none font-bold text-slate-900 dark:text-white">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-5 py-4 dark:bg-slate-800 border-none rounded-2xl outline-none font-bold text-slate-900 dark:text-white"
