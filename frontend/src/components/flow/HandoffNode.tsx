...
export const HandoffNode = ({ data }: any) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border-2 border-rose-500 w-64 overflow-hidden opacity-90">
      <Handle type="target" position={Position.Top} className="w-3 h-3 bg-rose-500" />
      <div className="bg-rose-500/10 dark:bg-rose-500/20 px-4 py-3 flex items-center gap-2 border-b border-rose-500/20">
