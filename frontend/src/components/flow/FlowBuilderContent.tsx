      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        <div className="flex-1 relative" ref={reactFlowWrapper}>
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 w-6 h-16 bg-white dark:bg-[#11141b] border-y border-l border-slate-200 dark:border-slate-800 flex items-center justify-center rounded-l-md shadow-md z-50 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
          >
        ...
        {/* Right Toolbar */}
        <div className={`bg-white dark:bg-[#11141b] border-l border-slate-200 dark:border-slate-800 flex flex-col z-10 shadow-2xl shrink-0 transition-all duration-300 ease-in-out overflow-hidden ${isSidebarOpen ? 'w-96' : 'w-0 border-l-0'}`}>
